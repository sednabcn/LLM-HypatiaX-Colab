...
'''
    ...
    def extend_existing_domain(self, domain_name: str, 
        ...
        Args:
            ...
            add_scripts: List of script types to add (defaults to ['llm', 'transformer', 'agent'])
        """
        if add_scripts is None:
            add_scripts = ['llm', 'transformer', 'agent']
...
def main():
    ...
    while True:
        print("\n" + "=" * 60)
        print("Options:")
        print("  1. Extend existing domain (add llm/transformer/agent)")
        print("  2. Create new domain")
        print("  3. Show current structure")
        print("  4. Quick setup: Extend 'queries' domain")
        print("  5. Exit")
        print("=" * 60)
        ...
        if choice == '1':
            ...
            if domain:
                scripts = input("Scripts to add (comma-separated, default: llm,transformer,agent): ").strip()
                if scripts:
            ...
            print("\n🚀 Quick Setup: Extending 'queries' domain...")
