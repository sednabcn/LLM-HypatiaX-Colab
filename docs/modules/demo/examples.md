...
- `__post_init__(self)`
- `to_dict(self) -> Dict[<ast.Tuple object at 0x7fa6f86e4310>]`
  - Convert to dictionary
- `from_dict(cls, data: Dict[<ast.Tuple object at 0x7fa6f889c710>]) -> <ast.Constant object at 0x7fa6f889c3d0>`
...
- `split_dataset(self, train_ratio: float, val_ratio: float, test_ratio: float, shuffle: bool) -> Tuple[<ast.Tuple object at 0x7fa6f88279d0>]`
...
- `get_statistics(self) -> Dict[<ast.Tuple object at 0x7fa6f86d3f50>]`
