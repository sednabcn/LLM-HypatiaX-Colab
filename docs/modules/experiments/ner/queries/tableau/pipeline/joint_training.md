# Module: `experiments/ner/queries/tableau/pipeline/joint_training.py`
...
- `__init__(self)`
- `train(self, training_data: List[Tuple[<ast.Tuple object at 0x7fa6f8519490>]])`
...
- `evaluate(self, test_data: List[Tuple[<ast.Tuple object at 0x7fa6f88a1790>]]) -> Dict`
...
- `analyze(model: JointMappingModel, test_case: Tuple[<ast.Tuple object at 0x7fa6f85b0750>])`
