# Module: `backup_before_extension/experiments/experiment_tracker.py`
...
- `_load_registry(self) -> Dict[<ast.Tuple object at 0x7fa6f8514890>]`
  - Load experiment registry from file
- `_save_registry(self)`
  - Save experiment registry to file
- `register_experiment(self, name: str, technology: TechnologyType, description: str, author: str, config: Dict[<ast.Tuple object at 0x7fa6f85762d0>], tags: List[str]) -> str`
  - Register a new experiment
- `update_experiment(self, exp_id: str, status: Optional[ExperimentStatus], metrics: Optional[Dict[<ast.Tuple object at 0x7fa6f88934d0>]], notes: Optional[str])`
