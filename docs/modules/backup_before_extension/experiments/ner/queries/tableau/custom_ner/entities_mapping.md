# Module: `backup_before_extension/experiments/ner/queries/tableau/custom_ner/entities_mapping.py`
...
- `train_from_pairs(self, training_pairs: List[Tuple[<ast.Tuple object at 0x7fa6f85efa90>]])`
...
- `generate_with_validation(self, formula_entities: List[Dict]) -> Tuple[<ast.Tuple object at 0x7fa6f8514790>]`
