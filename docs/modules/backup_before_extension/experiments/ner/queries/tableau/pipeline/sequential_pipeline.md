# Module: `backup_before_extension/experiments/ner/queries/tableau/pipeline/sequential_pipeline.py`
...
- `evaluate(self, test_data: List[Tuple[<ast.Tuple object at 0x7fa6f866dad0>]]) -> Dict`
...
- `evaluate(self, test_data: List[Tuple[<ast.Tuple object at 0x7fa6f852b510>]]) -> Dict`
...
- `evaluate(self, test_data: List[Tuple[<ast.Tuple object at 0x7fa6f854da90>]]) -> Dict`
...
- `evaluate(self, test_data: List[Tuple[<ast.Tuple object at 0x7fa6f86e7850>]]) -> Dict`
