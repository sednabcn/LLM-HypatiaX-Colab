# Module: `backup_before_extension/demo/ui.py`
...
- `entity_visualization(text: str, entities: List[Dict[<ast.Tuple object at 0x7fa6f852b310>]], use_colors: bool) -> str`
...
- `metric_cards(metrics: Dict[<ast.Tuple object at 0x7fa6f8666190>], columns: int) -> str`
  - Display metrics in card format
- `comparison_table(results: List[Dict[<ast.Tuple object at 0x7fa6f85c2610>]], show_entities: bool) -> str`
