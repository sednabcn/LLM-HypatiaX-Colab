# Module: `backup_before_extension/demo/engine.py`
...
- `_load_vocab_mappings(self) -> Dict[<ast.Tuple object at 0x7fa6f86f6290>]`
...
- `get_stats(self) -> Dict[<ast.Tuple object at 0x7fa6f856c190>]`
