...
class ModelConfig:
    ...
    @classmethod
    def training_desc(cls, 
                     niter: int = 100,
                     batchsize: int = 8,
                     sizefile: str = 'sm') -> 'ModelConfig':
        """
        ...
        return cls(
            training=TrainingConfig(
                niter=niter,
                batchsize=batchsize,
                output_model_name='ner_tableau_desc'
            ),
            data=DataConfig.for_descriptions().update(sizefile=sizefile)
        )
    
    @classmethod
    def training_formulas(cls,
                         niter: int = 100,
                         batchsize: int = 8,
                         sizefile: str = 'sm') -> 'ModelConfig':
    ...
    @classmethod
    def training_combined(cls,
                         niter: int = 150,
                         batchsize: int = 8,
                         sizefile: str = 'md') -> 'ModelConfig':
    ...
    def quick_test(cls) -> 'ModelConfig':
        ...
        return cls(
            training=TrainingConfig.quick_train(),
            data=DataConfig.for_descriptions()
        )
...
class EvaluationConfig:
    ...
    metrics: List[str] = field(default_factory=lambda: [
        'ents_f', 'ents_p', 'ents_r', 'ents_per_type'
    ])
