...
class PathConfig:
    ...
    def list_available_paths(self) -> List[str]:
        ...
        return [
            'root', 'hypatiax', 'datasets', 'data_spacy', 'outputs', 'tests',
            'agents', 'core', 'models', 'tools', 'utils', 'custom_entities',
            'custom_ner', 'config_dir', 'patterns', 'mappings', 'examples',
            'experiments', 'docs', 'demo'
        ]
