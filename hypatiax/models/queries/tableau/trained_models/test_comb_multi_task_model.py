...
model_path=resources.files('hypatiax.models.queries.tableau.trained_models').joinpath(f"Multitask_1_sm_tableau_{niter}_{drop}_{batchsize}") 
...
nlp=M.load(f"Multitask_1_sm_tableau_{niter}_{drop}_{batchsize}",'models')
