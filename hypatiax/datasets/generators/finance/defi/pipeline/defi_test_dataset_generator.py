...
class DeFiTestDataGenerator:
    ...
    def generate_utilization_data(self, n_samples: int = 100) -> List[Dict]:
        ...
        for i in range(n_samples):
            ...
            total_borrowed = total_supplied * target_util * np.random.uniform(0.95, 1.05)
    ...
    def generate_health_factor_data(self, n_samples: int = 100) -> List[Dict]:
        ...
        for i in range(n_samples):
            ...
            borrowed_value = collateral_value * liquidation_threshold * np.random.uniform(0.5, 0.95)
    ...
    def save_all_datasets(self, output_dir: str = "test_data", n_samples: int = 100):
        ...
        datasets = {
            ...
            'concentrated_liquidity': self.generate_concentrated_liquidity_data(n_samples),
