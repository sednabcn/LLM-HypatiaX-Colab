...
def generate_advanced_defi(n_samples=150, noise_level=0.01):
    ...
    system.discover_validate_interpret(
        ...
        variable_units={'capital': 'USD', 'fee_apy': 'percent', 'volatility': 'percent', 'risk_tolerance': 'dimensionless'},
...
if __name__ == "__main__":
    ...
    system = generate_advanced_defi(n_samples=150, noise_level=0.01)
    
    # Optional: Generate with more samples for better model training
    # system = generate_advanced_defi(n_samples=250, noise_level=0.005)

"""
Key Improvements
1. Corrected Formulas

Price Impact: Now uses proper constant product AMM formula (x·y=k)
Liquidation Prices: Separate formulas for long/short with correct signs
Position Sizing: Incorporates fee APY for realistic LP decisions

2. New Advanced Formulas

Flash Loan Arbitrage: Profit calculation including fees and gas
Concentrated Liquidity (V3): Range width based on volatility
Utilization Rate: Core lending protocol metric
Dynamic Interest Rates: Kinked rate model (Aave-style)
Health Factor: Critical lending safety metric

3. Realistic Parameters

Price ranges match crypto markets (1k-50k for BTC/ETH)
Volatility ranges realistic (1-10% daily)
Leverage limits realistic (2-20x)
Maintenance margins typical (3-10%)

4. Better Data Quality

Constraints ensure logical relationships (borrows ≤ supply)
Noise scaled to mean values for proportional realism
Progress indicators during generation

5. Diverse Formula Types

AMM mechanics: Price impact, IL
Risk management: Liquidations, position sizing
Lending protocols: Utilization, rates, health factor
Arbitrage: Flash loan profits
Liquidity provision: Range optimization

This dataset now covers the full spectrum of advanced DeFi concepts and will train your discovery system on realistic, diverse formulas
"""
