...
def generate_advanced_risk(n_samples=150, noise_level=0.001):
    ...
    system.discover_validate_interpret(
        ...
        variable_units={"mu": "percent", "sigma": "percent", "skewness": "dimensionless", "kurtosis": "dimensionless"},
    ...
    portfolio_vol_div = np.sqrt(
        weight_1**2 * sigma_1**2 + weight_2**2 * sigma_2**2 + 2 * weight_1 * weight_2 * sigma_1 * sigma_2 * correlation
    )
    ...
    system.discover_validate_interpret(
        ...
        variable_descriptions={"volatility": "Return volatility", "sharpe": "Sharpe ratio", "horizon": "Time horizon"},
...
def generate_stress_testing(n_samples=120, noise_level=0.01):
    ...
    system.discover_validate_interpret(
        ...
        variable_units={"portfolio": "USD", "duration": "years", "rate_shock": "percent", "convexity": "dimensionless"},
    ...
    system.discover_validate_interpret(
        ...
        variable_units={"portfolio": "USD", "vega": "USD/percent", "vol_increase": "percent", "gamma": "dimensionless"},
    ...
    X = np.column_stack([asset1_exposure, asset2_exposure, normal_correlation, stress_correlation, volatility_mult])
...
def generate_margin_formulas(n_samples=120, noise_level=100):
    ...
    system.discover_validate_interpret(
        ...
        variable_units={"position": "USD", "leverage": "x", "volatility": "percent", "liquidity": "dimensionless"},
    ...
    system.discover_validate_interpret(
        ...
        variable_units={"win_rate": "percent", "avg_win": "percent", "avg_loss": "percent", "capital": "USD"},
