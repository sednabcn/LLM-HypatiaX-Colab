...
perfume_data_extension = [
    ...
    [
        "Calculate material waste allowance",
        "Waste = Production Amount × 1.05 (5% safety)",
    ],
    ...
    [
        ...
        "Overhead/Unit = Total Overhead / Units",
    ],
    [
    ...
    [
        "Determine reorder point level",
        "Reorder = (Daily Use × Lead Days) + Safety Stock",
    ],
    [
    ...
    [
        ...
        "Utilization = (Actual / Maximum Capacity) × 100",
    ],
    ["Determine standard cost variance", "Variance = (Actual - Standard) × Quantity"],
    [
        "Calculate material yield variance",
        "Yield Var = (Actual - Standard Yield) × Std Price",
    ],
    [
        "Find price variance procurement",
        "Price Var = (Actual - Standard Price) × Quantity",
    ],
    [
        "Calculate labor efficiency variance",
        "Labor Var = (Actual - Standard Hours) × Rate",
    ],
    ...
    [
        "Find remaining shelf life",
        "RSL = Initial × (Current Quality / Initial Quality)",
    ],
    ...
    [
        "Calculate gage repeatability reproducibility",
    ...
    [
        "Calculate packaging recyclability",
        "Recyclable = (Recyclable / Total Pack) × 100",
    ],
