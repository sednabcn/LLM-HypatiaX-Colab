...
clinical_data_extension = [
    ...
    [
        ...
        "CCI = (Post-Plt - Pre-Plt) × BSA / Units",
    ],
    # Molecular Diagnostics (25 entries)
    [
        "Calculate PCR cycle threshold",
        "Ct Value = Cycle where fluorescence crosses threshold",
    ],
    ...
    [
        "Calculate melting temperature primer",
        "Tm°C = 64.9 + 41 × (G+C-16.4) / Primer Length",
    ],
    ...
    [
        "Determine DNA concentration ratio",
        "260/280 = 1.8 (pure DNA), <1.8 protein contamination",
    ],
    ["Calculate RNA purity ratio", "260/280 = 2.0 (pure RNA)"],
    ["Find DNA yield extraction", "Yield μg = Concentration × Volume"],
    [
        "Calculate viral load quantification",
        "Viral Load = Copies/mL from standard curve",
    ],
    [
        "Determine sequencing coverage depth",
    ...
    [
        "Determine gene expression fold change",
        "Fold Change = Treated / Control Expression",
    ],
    ...
    [
        "Find mitochondrial heteroplasmy",
        "Heteroplasmy % = Mutant mtDNA / Total mtDNA × 100",
    ],
    ...
    [
        ...
        "Subset % = (Subset / Lymphocyte Count) × 100",
    ],
    ...
    [
        ...
        "Cryoglobulin = Cryocrit % after 72h at 4°C",
    ],
