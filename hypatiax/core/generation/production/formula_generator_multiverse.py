...
class SmartLookupStrategy:
    ...
    def _extract_variables(self, formula: str) -> List[Dict]:
        ...
        return [
            {'name': v, 'description': f'Variable {v}', 'unit': 'dimensionless', 'type': 'float'}
...
class FormulaGeneratorMultiverse:
    ...
    def generate_all_strategies(self, 
                                query: str, 
                                domain: str = 'defi',
                                parallel: bool = True) -> MultiStrategyResult:
        """
            ...
            with ThreadPoolExecutor(max_workers=len(self.strategies)) as executor:
                ...
                for future in as_completed(future_to_strategy):
                    ...
                    try:
                        ...
                        logging.info(f"✓ {strategy_name.value}: {strategy_result.status} "
    ...
    def export_results(self, filepath: str):
        ...
        for multi_result in self.results_history:
            result_dict = {
                ...
                'recommended_strategy': multi_result.recommended_strategy.value if multi_result.recommended_strategy else None,
