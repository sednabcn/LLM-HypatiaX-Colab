...
class PipelineExecutor:
    ...
    def step_train_transformer(self):
        ...
        try:
            from training_transformer import TransformerTrainer, TransformerConfig
    ...
    def step_train_rag(self):
        ...
        try:
            from training_rag import RAGTrainer, RAGConfig
    ...
    def step_train_llm(self):
        ...
        try:
            from training_llm import LLMTrainer, LLMConfig
    ...
    def step_evaluate_all(self):
        ...
        try:
            from evaluation_unified import ModelEvaluator, ComparisonReport
    ...
    def print_summary(self):
        ...
        failed_steps = [name for name, result in self.results.items() 
...
def main():
    ...
    parser.add_argument(
        '--steps',
        nargs='+',
        choices=['prepare_data', 'train_spacy', 'train_transformer', 
                'train_rag', 'train_llm', 'evaluate_all', 'deploy'],
