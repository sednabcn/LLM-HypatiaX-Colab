...
class PredictionService:
    ...
    def predict_with_ensemble(self, model_name: str, text: str, 
...
def main():
    ...
    context = MappingContext(
        ...
        data_types={"Sales": "float", "Revenue": "float", "Profit": "float", 
    ...
    if FLASK_AVAILABLE:
        ...
        # Demo prediction
        result = api.service.predict(
            "ensemble",
            "average of Sales by Region"
        )
        print(f"\nExample prediction:")
