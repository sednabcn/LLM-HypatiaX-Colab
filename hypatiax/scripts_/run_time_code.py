...
def main():
    ...
    try:
        ...
        config_path = resources.files('hypatiax.models.queries.tableau.model_configs').joinpath(f'config_data_preparation_{i}.csv')
    ...
    try:
        config_training_save = {k: v for k, v in config_training.items() 
        ...
        config_training_path = resources.files('hypatiax.models.queries.tableau.model_configs').joinpath(f'config_training_{i}.csv')
    ...
    try:
        ...
        model_base_path = resources.files(f'hypatiax.models.{config_training["domain"]}.{config_training["sub_domain"]}')
