...
def save_config(test_id, config, time_id):
    ...
    try:
        ...
        config_training_save = {k: v for k, v in config[1].items() 
...
def run_test(test_id, config):
    ...
    print(f"{'='*70}")
    print(f"Data Config: dtype={config[0]['dtype']}, sizefile={config[0]['sizefile']}, "
          f"task_type={config[0]['task_type']}")
    print(f"Training Config: model={config[1]['output_model_name']}, "
...
def main():
    ...
    test_configurations = {
        ...
        '1': [
            {
                'modules': 'datasets', 'domain': 'queries', 'sub_domain': 'tableau',
                'actions': 'training', 'filename': 'formulas_nor.xlsx', 'dtype': 'desc',
                'sizefile': 'sm', 'test_size': 0.2, 'task_type': 'single',
                'ner_entity': 'ner_queries_desc', 'dataset_normalized': None,
                'val_data': False, 'option': None
            },
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'desc', 'output_model_name': 'Description_sm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': None
            }
        ],
        ...
        '2': [
            {
                'modules': 'datasets', 'domain': 'queries', 'sub_domain': 'tableau',
                'actions': 'training', 'filename': 'formulas_nor.xlsx', 'dtype': 'formulas',
                'sizefile': 'sm', 'test_size': 0.2, 'task_type': 'single',
                'ner_entity': 'ner_queries_formulas', 'dataset_normalized': None,
                'val_data': False, 'option': None
            },
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'formulas', 'output_model_name': 'Formulas_sm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': None
            }
        ],
        ...
        '3': [
            {
                'modules': 'datasets', 'domain': 'queries', 'sub_domain': 'tableau',
                'actions': 'training', 'filename': 'formulas_nor_combined.xlsx',
                'dtype': 'both', 'sizefile': 'sm', 'test_size': 0.2,
                'task_type': 'multitask', 'ner_entity': 'ner_queries',
                'dataset_normalized': None, 'val_data': False, 'option': None
            },
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'both', 'output_model_name': 'Multitask_1_sm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': 1
            }
        ],
        ...
        '4': [
            ...
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'both', 'output_model_name': 'Multitask_2_sm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': 2
            }
        ],
        ...
        '5': [
            {
                ...
                'actions': 'training', 'filename': 'formulas_nor_combined.xlsx',
                'dtype': 'both', 'sizefile': 'sm', 'test_size': 0.2,
                'task_type': 'single', 'ner_entity': 'ner_queries',
                'dataset_normalized': None, 'val_data': False, 'option': None
            },
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'both', 'output_model_name': 'Combined_sm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': None
            }
        ],
        ...
        '6': [
            {
                ...
                'dtype': 'both', 'sizefile': 'sm', 'test_size': 0.2,
                'task_type': 'single', 'ner_entity': 'ner_queries',
                'dataset_normalized': None, 'val_data': True, 'option': 'split'
            },
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'both', 'output_model_name': 'Combined_split_sm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': None
            }
        ],
        ...
        '7': [
            {
                'modules': 'datasets', 'domain': 'queries', 'sub_domain': 'tableau',
                'actions': 'training', 'filename': 'gformulas_nor_combined.xlsx',
                'dtype': 'desc', 'sizefile': 'bsm', 'test_size': 0.2,
                'task_type': 'single', 'ner_entity': 'ner_queries_desc',
                'dataset_normalized': None, 'val_data': True, 'option': 'split'
            },
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'desc', 'output_model_name': 'Combined_desc_bsm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': None
            }
        ],
        ...
        '8': [
            {
                'modules': 'datasets', 'domain': 'queries', 'sub_domain': 'tableau',
                'actions': 'training', 'filename': 'gformulas_nor_combined.xlsx',
                'dtype': 'formulas', 'sizefile': 'bsm', 'test_size': 0.2,
                'task_type': 'single', 'ner_entity': 'ner_queries_formulas',
                'dataset_normalized': None, 'val_data': True, 'option': 'split'
            },
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'formulas', 'output_model_name': 'Combined_formulas_bsm',
                'niter': 400, 'drop': 0.5, 'batchsize': 8, 'patience': 10,
                'n_checkpoint': 100, 'val_data': None, 'option': None
            }
        ],
        ...
        '9': [
            {
                'modules': 'datasets', 'domain': 'queries', 'sub_domain': 'tableau',
                'actions': 'training', 'filename': 'gformulas_nor_combined.xlsx',
                'dtype': 'both', 'sizefile': 'bsm', 'test_size': 0.2,
                'task_type': 'multitask', 'ner_entity': 'ner_queries',
                'dataset_normalized': None, 'val_data': True, 'option': 'split'
            },
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'both', 'output_model_name': 'Multitask_1_bsm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': 1
            }
        ],
        ...
        '10': [
            ...
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'both', 'output_model_name': 'Multitask_2_bsm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': 2
            }
        ],
        ...
        '11': [
            ...
            {
                'domain': 'queries', 'sub_domain': 'tableau', 'train_data': None,
                'dtype': 'both', 'output_model_name': 'Combined_both_bsm', 'niter': 400,
                'drop': 0.5, 'batchsize': 8, 'patience': 10, 'n_checkpoint': 100,
                'val_data': None, 'option': None
            }
        ]
