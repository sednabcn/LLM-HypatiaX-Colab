...
def rebuild_models():
    ...
    ruler_formulas.from_disk(
        "hypatiax/custom_ner/queries/tableau/rules/ruler_tableau_formulas.jsonl"
    )
    ...
    ruler_desc.from_disk(
        "hypatiax/custom_ner/queries/tableau/rules/ruler_tableau_desc.jsonl"
    )
