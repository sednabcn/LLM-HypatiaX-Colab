...
class DimensionalValidator:
    ...
    def validate(self, expression_str: str, variable_units: Dict[str, str]) -> Dict:
        """
...
if __name__ == "__main__":
    ...
    result1 = validator.validate(expression_str="price1 + price2", variable_units={"price1": "USD", "price2": "USD"})
