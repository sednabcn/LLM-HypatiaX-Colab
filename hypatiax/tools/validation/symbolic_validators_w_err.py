...
class SymbolicValidator:
    ...
    def _check_numerical_stability(self, expr) -> Dict[str, Any]:
        ...
        if expr.has(sp.log):
            warnings.append("Logarithm present - ensure positive inputs")
...
if __name__ == "__main__":
    ...
    result1 = validator.validate(expression="2*x + 3", variable_definitions={"x": "Input variable"}, domain="finance")
    ...
    result2 = validator.validate(expression="2*x + y", variable_definitions={"x": "Input variable"}, domain="defi")
