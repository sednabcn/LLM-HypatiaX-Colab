...
import math
import pytest
from uniswap_v2_formulas_extended import DeFiAdvancedCalculator, EPSILON
...
@given(st.floats(min_value=1e-6, max_value=1e6), st.floats(min_value=0.0, max_value=1.0), st.floats(min_value=0.0, max_value=10.0))
