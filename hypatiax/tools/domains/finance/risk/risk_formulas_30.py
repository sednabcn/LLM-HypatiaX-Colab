...
class RiskCalculator:
    ...
    @staticmethod
    def calculate_m_squared(returns: np.ndarray, risk_free_rate: float, 
                           benchmark_vol: float) -> Dict:
...
class ComprehensiveRiskAnalyzer:
    ...
    def analyze_portfolio_complete(self, position: PortfolioPosition) -> Dict:
        ...
        treynor_result = self.calculator.calculate_treynor_ratio(returns, benchmark_returns, 
        ...
        m2_result = self.calculator.calculate_m_squared(returns, position.risk_free_rate / 252, 
    ...
    def _assess_comprehensive_risk_rating(self, sharpe: float, beta: float, 
                                         mdd: float, stability: float, 
                                         recovery: float) -> str:
...
if __name__ == "__main__":
    ...
    for position in positions:
        ...
        print(f"{result['position_name']:<25} {result['total_return_pct']:>7.2f}% "
