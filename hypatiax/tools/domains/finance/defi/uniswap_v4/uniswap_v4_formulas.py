...
class UniswapV4Math:
    ...
    @staticmethod
    def calculate_amounts(L: float, price_lower: float,
...
class V4HookSimulator:
    ...
    def after_swap(self, amount_out: float) -> Dict:
        ...
        return {
            'final_amount': amount_out - protocol_fee,
...
class UniswapV4Calculator:
    ...
    @staticmethod
    def calculate_v4_il_with_hooks(position: V4Position, 
                                   hook: Optional[V4HookSimulator] = None) -> Dict:
        """
...
if __name__ == "__main__":
    ...
    dynamic_fee_hook = V4HookSimulator(
        "DynamicFeeHook",
        [HookPermissions.BEFORE_SWAP, HookPermissions.AFTER_SWAP]
    )
    ...
    for idx, position in enumerate(positions):
        ...
        print(f"{result['position_name']:<45} {range_str:>15} "
