...
def export_results_to_csv(
    results: List[Dict], 
    filename: str = "uniswap_v2_results_validated.csv"
):
    ...
    # Define column order
    fieldnames = [
        'position_name', 'valid', 'price_ratio', 'il_percent', 'il_dollar',
        'daily_fees', 'total_fees', 'net_result', 'breakeven_days', 
        'profitable', 'days_elapsed', 'daily_volume_usd',
...
if __name__ == "__main__":
    ...
    try:
        ...
        results = []
        print(f"{'Position':<40} {'Valid':>6} {'IL %':>10} {'IL $':>12} {'Fees':>12} {'Net $':>12} {'BE Days':>10} {'Profit':>8}")
        print("-" * 130)
        ...
        for position in positions:
            try:
                ...
                print(f"{result['position_name']:<40} {valid_marker:>6} "
