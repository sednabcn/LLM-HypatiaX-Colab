"""
Enhanced Symbolic Engine v15 - FIXED BERNOULLI VALIDATION
==========================================================
CRITICAL FIXES:
...
SOLVES: Bernoulli equation validation failures!
"""
...
def detect_collapsed_constants(expr: str, variable_names: List[str]) -> Dict:
    ...
    return {
        ...
        "reason": f"Found {len(suspicious_constants)} suspicious constants"
...
class AutoConfigurationEngine:
    ...
    def configure_discovery(
        ...
        ✅ FIX #2: Ban log/sqrt for Bernoulli (critical for validation)
        """
        ...
        # ✅ FIX #2: Ban log/sqrt for Bernoulli (critical for validation)
        if equation_hint == "bernoulli_equation":
            print("\n[HINT OVERRIDE] Applying Bernoulli physics constraints")
            return {
                "binary_operators": ["+", "-", "*", "/", "**"],
                "unary_operators": [],  # 🚫 No log, no sqrt - violates physics
                "maxsize": 20,
                "parsimony": 0.001,
                "niterations": int(self.base_iterations * 1.5),
                "reason": "Bernoulli: additive energy conservation (no transcendental functions)",
            }
...
# ============================================================================
# SYMBOLIC ENGINE v15 - WITH FIXES
# ============================================================================


class SymbolicEngine:
    """Symbolic Engine v15 - CRITICAL FIXES for Bernoulli validation."""
...
if __name__ == "__main__":
    print("=" * 80)
    print("SYMBOLIC ENGINE v15 - BERNOULLI VALIDATION FIX")
    print("=" * 80)
    print()
    ...
    print("\n" + "=" * 80)
    print("✅ v15 WITH BERNOULLI FIXES!")
    print("=" * 80)
    print("\nKey Fixes:")
    print("  • Fix #1: Override SMART structure when equation hint is known")
    print("  • Fix #2: Ban log/sqrt for Bernoulli (enforces correct physics)")
    print("  • Fixed 'NoneType' object is not subscriptable error")
    print("  • Proper null checking after PySR fit")
    print("  • Smart structure detection integrated")
    print("  • All iterations configurable from base_iterations")
    print("=" * 80)
