...
class UIComponents:
    ...
    def table(
        ...
        # Format header
        header_row = "|" + "|".join(
            str(h).center(col_widths[i]) for i, h in enumerate(headers)
        ) + "|"
...
class InteractiveDemo:
    ...
    def _process_query(self):
        ...
        print(self.ui.entity_visualization(
            result.query,
