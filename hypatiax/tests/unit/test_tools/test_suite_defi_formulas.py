...
from uniswap_v2_formulas_extended import (
    DeFiAdvancedCalculator,
    DeFiBacktestAnalyzer,
    generate_defi_advanced_scenarios,
)
...
def test_collateral_coverage():
    res = calc.collateral_coverage_multi(
        [
            {"value": 1000, "threshold": 0.8},
            {"value": 2000, "threshold": 0.5}
        ],
        total_debt=2000
    )
