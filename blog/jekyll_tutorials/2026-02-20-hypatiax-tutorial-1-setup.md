...
description: "Install HypatiaX and discover your first scientific equation in under 15 minutes"
---
...
**Time:** 15 minutes  
**Difficulty:** Beginner  
**Next:** [Tutorial 2: Running Benchmark Experiments]({% post_url 2026-02-21-hypatiax-tutorial-2-experiments %})
...
1. **[Tutorial 2: Running Benchmark Experiments]({% post_url 2026-02-21-hypatiax-tutorial-2-experiments %})** - Reproduce the 131 test suite
2. **[Tutorial 3: Analysis and Visualization]({% post_url 2026-02-22-hypatiax-tutorial-3-analysis %})** - Generate publication figures
3. **[Tutorial 4: Custom Applications]({% post_url 2026-02-23-hypatiax-tutorial-4-extensions %})** - Apply to your domain
...
- **Code:** [GitHub Repository](https://github.com/yourusername/hypatiax)
- **Issues:** [Bug Reports & Questions](https://github.com/yourusername/hypatiax/issues)
