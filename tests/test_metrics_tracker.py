...
class TestMetricsTracker:
    ...
    def run_tests(self, test_path: str = "tests/", with_coverage: bool = True, verbose: bool = True) -> TestMetrics:
...
def main():
    ...
    parser.add_argument("--test-path", "-p", default="tests/", help="Path to tests (default: tests/)")
    ...
    metrics = tracker.run_tests(test_path=args.test_path, with_coverage=not args.no_coverage, verbose=not args.quiet)
...
"""
I've created a comprehensive Test Metrics Tracker! Here's how to use it:
Basic Usage
bash# Make it executable
chmod +x test_metrics_tracker.py

# Run tests and track metrics
python test_metrics_tracker.py

# Run without coverage (faster)
python test_metrics_tracker.py --no-coverage

# Run specific test path
python test_metrics_tracker.py --test-path tests/unit/validators/
View Reports
bash# Compare with previous run
python test_metrics_tracker.py --compare

# Show historical trends
python test_metrics_tracker.py --history

# Show last 20 runs
python test_metrics_tracker.py --history --limit 20

# Generate markdown report
python test_metrics_tracker.py --report test_report.md
Features
✅ Automatic Tracking

Pass rate, coverage, duration
Stores history in .test_metrics_history.json
...
Pass rate: 71.4% → 80%+ tracking

The script will show you exactly where you stand and how you're improving! 🎯
"""
