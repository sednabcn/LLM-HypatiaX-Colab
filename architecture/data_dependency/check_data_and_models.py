        ...
        for dataset_path in dataset_paths:
            if dataset_path.exists():
                ...
                self.results["datasets"][
                    str(dataset_path.relative_to(self.project_root))
                ] = {
                    "exists": True,
                        ...
                        if item.is_dir():
                            if (item / "meta.json").exists() or (
                                ...
                                try:
                                    ...
                                    print(
                                        f"   🏷️  Labels: {nlp.get_pipe('ner').labels if 'ner' in nlp.pipe_names else 'N/A'}"
                                    )
            ...
            if component_files:
                ...
                for comp_file in component_files:
                    ...
                    try:
                        ...
                        spec = __import__(
                            "importlib.util"
                        ).util.spec_from_file_location(comp_file.stem, comp_file)
