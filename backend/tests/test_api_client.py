...
class DeFiAPIClient:
    ...
    def calculate_il_percentage(self, initial_price: float, current_price: float) -> Dict[str, Any]:
        ...
        return self._post("/defi/il-percentage", {
    ...
    def calculate_quality_score(
        ...
        return self._post("/defi/quality-score", {
    ...
    def analyze_position(
        ...
        return self._post("/defi/analyze-position", {
...
def main():
    ...
    il_result = client.calculate_il_percentage(
        initial_price=2000,
        current_price=3000
    )
