...
def main():
    ...
    # Test single mapping
    test_endpoint("POST", "/api/hypatiax/map", 
                 data={
    ...
    test_endpoint("POST", "/api/hypatiax/batch",
                 data={
                     "descriptions": [
                         "Sum of Sales",
                         "Average of Profit",
    ...
    # Test endpoint
    test_endpoint("GET", "/api/hypatiax/test",
    ...
    test_endpoint("GET", "/api/ner/health",
                 description="NER service health check")
    
    test_endpoint("POST", "/api/ner/extract-formula",
                 data={
    ...
    test_endpoint("POST", "/api/ner/recognize-entities",
                 data={
    ...
    test_endpoint("POST", "/api/ner/convert-to-latex",
                 data={
    ...
    test_endpoint("GET", "/api/defi/health",
                 description="DeFi service health check")
    
    test_endpoint("POST", "/api/defi/calculate-il",
                 data={
    ...
    test_endpoint("POST", "/api/defi/calculate-quality-score",
                 data={
    ...
    test_endpoint("POST", "/api/defi/analyze-position",
                 data={
                     "initial_token_a": 1.0,
