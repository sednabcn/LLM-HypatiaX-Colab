...
from baseline_pure_llm_defi import PureLLMBaseline
from baseline_neural_network_defi_improved import NeuralNetworkBaseline
...
"""
    ...
    elif ensemble_r2 > max(nn_r2 or -999, llm_r2 or -999):
