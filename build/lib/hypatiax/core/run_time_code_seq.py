...
from hypatiax.core.preprocessing.preparation_data import preparation_task, preparation_unlabeled_multitask_data, preparation_unlabeled_single_data
...
{'1':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'formulas_nor.xlsx', 'dtype': 'desc','ner_entity': 'ner_queries_desc', 'sizefile': 'sm','task_type':'single','dataset_normalized':None,'val_data':False, 'test_size': 0.2,'option':None},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'desc','output_model_name':'Description_sm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option': None}],
 '2':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'formulas_nor.xlsx', 'dtype': 'formulas','ner_entity': 'ner_queries_formulas', 'sizefile': 'sm','task_type':'single','dataset_normalized':None,'val_data':False, 'test_size': 0.2,'option':None},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'formulas','output_model_name':'Formulas_sm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data:None','option': None}],
# multitask-option 1-sm
'3':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'formulas_nor_combined.xlsx', 'dtype': 'both','ner_entity': 'ner_queries', 'sizefile': 'sm','task_type':'multitask','dataset_normalized':None,'val_data':False, 'test_size': 0.2,'option':None},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'both','output_model_name':'Multitask_1_sm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option':1}],
# multitask-option 2-sm
'4':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'formulas_nor_combined.xlsx', 'dtype': 'both','ner_entity': 'ner_queries', 'sizefile': 'sm','task_type':'multitask','dataset_normalized':None,'val_data':False, 'test_size': 0.2,'option':None},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'both','output_model_name':'Multitask_2_sm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option':2}],
# single -non-split-both -ner-queries-sm
'5':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'formulas_nor_combined.xlsx', 'dtype': 'both','ner_entity': 'ner_queries', 'sizefile': 'sm','task_type':'single','dataset_normalized':None,'val_data':False, 'test_size': 0.2,'option':None},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'both','output_model_name':'Combined_sm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option': None}],
#single-splitting-both-ner-queries-sm
'6':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'formulas_nor_combined.xlsx', 'dtype': 'both','ner_entity': 'ner_queries', 'sizefile': 'sm','task_type':'single','dataset_normalized':None,'val_data':True, 'test_size': 0.2,'option':'split'},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'both','output_model_name':'Combined_sm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option': None}],
# single-split-desc-bsm
'7':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'gformulas_nor_combined.xlsx', 'dtype': 'desc','ner_entity': 'ner_queries_desc', 'sizefile': 'bsm','task_type':'single','dataset_normalized':None,'val_data':True, 'test_size': 0.2,'option':'split'},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'desc','output_model_name':'Combined_desc_bsm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option': None}],
# single-split-formulas-bsm
'8':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'gformulas_nor_combined.xlsx', 'dtype': 'formulas','ner_entity': 'ner_queries_formulas', 'sizefile': 'bsm','task_type':'single','dataset_normalized':None,'val_data':True, 'test_size': 0.2,'option':'split'},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'formulas','output_model_name':'Combined_formulas_bsm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option': None}],
# multitask-option 1-bsm
'9':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'gformulas_nor_combined.xlsx', 'dtype': 'both','ner_entity': 'ner_queries', 'sizefile': 'bsm','task_type':'multitask','dataset_normalized':None,'val_data':True, 'test_size': 0.2,'option':'split'},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'both','output_model_name':'Multitask_1_bsm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option':1}],
...
'11':[{'modules': 'datasets', 'domain': 'queries','sub_domain':'tableau','actions':'training','filename':'gformulas_nor_combined.xlsx', 'dtype': 'both','ner_entity': 'ner_queries', 'sizefile': 'bsm','task_type':'single','dataset_normalized':None,'val_data':True, 'test_size': 0.2,'option':'split'},{'domain': 'queries','sub_domain':'tableau','train_data':None,'dtype':'both','output_model_name':'Combined_both_bsm','niter': 400,'drop': 0.5,'batchsize': 8,'patience': 10,'n_checkpoint': 100,'val_data':None,'option': None}]
}
