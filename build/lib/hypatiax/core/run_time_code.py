...
if config_data_preparation["dtype"] == "both":
    entity_path = resources.files(f'hypatiax.data_spacy.{config_data_preparation["domain"]}.{config_data_preparation["sub_domain"]}').joinpath(f'ner_{config_data_preparation["sub_domain"]}')
else:
    entity_path = resources.files(f'hypatiax.data_spacy.{config_data_preparation["domain"]}.{config_data_preparation["sub_domain"]}').joinpath(f'ner_{config_data_preparation["sub_domain"]}_{config_data_preparation["dtype"]}')
