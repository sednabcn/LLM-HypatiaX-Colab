...
def patterns_rules(data,ind):
        ...
        if ind=="S":
            return Generation_custom_queries_patterns(data,stopwords).rules_queries_desc
        elif ind=="F":
            return Generation_custom_queries_patterns(data,stopwords).rules_queries_formulas
        else:
            pass
