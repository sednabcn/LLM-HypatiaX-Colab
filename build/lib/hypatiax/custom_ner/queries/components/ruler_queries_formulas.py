...
@Language.component("custom_queries_formulas_ruler")
def custom_queries_formulas_ruler_component(doc,nlp=nlp, name='custom_queries_formulas_ruler', rules_version="version1", domain="queries", type="formulas", path_to_file=None):
    ...
    custom_queries_formulas_ruler=create_ruler(rules=rules)
    return custom_queries_formulas_ruler(doc)
...
def setup_nlp_pipeline():
    nlp=spacy.load("en_core_web_sm")
    nlp.add_pipe("custom_queries_formulas_ruler",before="ner")
