...
#Test
try:
    nlp=F.load("ner_queries_desc","ner")
    print("File ner_queries_desc loaded successfully")
except:
    import spacy
    nlp=spacy.load("ner_queries_desc")
    nlp.pipe_line("ner_queries_desc",before="ner")
