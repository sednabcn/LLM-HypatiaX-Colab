...
def load_rules(version):
    ...
    path_to_file = resources.files('hypatiax.custom_ner.queries.rules').joinpath(f'rules_queries_formulas_{version}.jsonl')
...
def custom_queries_formulas_ruler_component(doc):
